...
if($wsLogSnsBtn['twitter'] == 1): ?>
	<div class="twitter">
<a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php echo $bcBaser->url($bcBaser->getHere() , true); ?>" data-count="horizontal"<?php if(isset($wsLogTwitterID)){ echo ' data-related="' . $wsLogTwitterID . '"'; } ?> data-lang="ja">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
	<!-- /.twitter --></div>
<?php endif ?>
